		...
		while(true)
		{
			...
			switch(option)
			{
				case 1:
					...
					System.out.println("Enter Customer Type (staff, srcitizen, staffsrcitizen)");
				...
				case 2:
					...
					System.out.println("Enter type of account savings,fd,homeloan");
					...
					AccountDetails accountDetails = new AccountDetails(cif,branchId,accountType,amount,years);
					...
					accountDao.updateInterest(interest,accountNo);
				...
				case 13:
					...
					if(accountDao.activateAccount(cif13,accountNo13))
						System.out.println("Äccount Activated");
					else
